...
public class ZoneDatabase {
	...
	private ZoneDatabase (){
		...
		zones.put ("Combat0001", 	new Zone ("Combat0001", "Combat",	"sceneCombat,Encounter1", 	88, 	112));
		zones.put ("Combat0002", 	new Zone ("Combat0002", "Combat",	"sceneCombat,Encounter1", 	188,	104));
		zones.put ("Combat0003", 	new Zone ("Combat0003",	"Combat",	"sceneCombat,Encounter2", 	288, 	112));
		zones.put ("Combat0004", 	new Zone ("Combat0004", "Combat",	"sceneCombat,Encounter3", 	388, 	104));
		zones.put ("Combat0005", 	new Zone ("Combat0005", "Combat",	"sceneCombat,Encounter4", 	488, 	104));
		zones.put ("Combat0006", 	new Zone ("Combat0006",	"Combat",	"sceneCombat,DarkLord", 	588, 	104));
		zones.put ("Arena0001", 	new Zone ("Arena0001",	"Arena",	"sceneCombat,Arena", 		688, 	112));
